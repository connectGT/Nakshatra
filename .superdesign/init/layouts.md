    ...
    >
      <div className="w-full px-6 md:px-[8vw] flex justify-between items-center">
        ...
        <div className="flex items-center z-50 h-full py-4 transition-opacity duration-300 hover:opacity-80">
          <img 
            src="/assets/brand/nakshatra-logo.png" 
            alt="Nakshatra Logo" 
    ...
    <footer className="bg-brand-navy pt-20 pb-10 px-6 md:px-12 border-t border-white/10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 mb-20">
        <div className="flex-1">
          <div className="text-xl font-display font-bold tracking-widest text-brand-silver mb-3">
            NAKSHATRA · THE AEROSPACE HACKATHON 2026
          </div>
          <p className="text-brand-silver/50 font-light max-w-sm text-sm leading-relaxed mb-1">
            Organised by Aerospace Club
          </p>
        ...
        <div className="flex gap-16 flex-wrap">
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-brand-silver/60 font-light">
              ...
              <li><a href="#why" className="hover:text-brand-blue transition-colors">Why Participate</a></li>
              <li><a href="#challenges" className="hover:text-brand-blue transition-colors">Challenges</a></li>
              <li><a href="#schedule" className="hover:text-brand-blue transition-colors">Timeline</a></li>
          ...
          <div>
            <h4 className="text-white font-mono text-xs tracking-widest mb-6">CONTACT</h4>
            <ul className="flex flex-col gap-3 text-sm text-brand-silver/60 font-light">
              <li>Shreya Goyal</li>
              <li><a href="mailto:shreyagoyal401@gmail.com" className="hover:text-brand-blue transition-colors">shreyagoyal401@gmail.com</a></li>
            </ul>
          </div>
        </div>
      </div>
